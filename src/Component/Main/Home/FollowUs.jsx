        ...
        <div>
            <div className="flex justify-center items-center py-16">
                <div className="text-center">
                    <h1 className="text-3xl font-semibold m-4">THE <span className="brand-color">WINTER BRAND</span> ON INSTAGRAM</h1>
                    <a target="_blank" href="" className='brand-color text-sm'>FOLLOW US ON INSTAGRAM</a>
                </div>
            </div>
            <div>
                <Slider {...settings}>

      ...
      <div>
        <div className="collapse collapse-arrow bg-orange-50 mt-4">
          ...
          <div className="collapse-content">
            <p>
              You can choose to get either 1 or 2 pairs of socks a month. The 2
              pair deal is only ~$5 more a month.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-orange-50 mt-4">
          ...
          <div className="collapse-content">
            <p>
              All of our socks are crew fitting socks. They will come up to your
              mid-calf. They are all made from a high quality combed cotton
              blend.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-orange-50 mt-4">
          ...
          <div className="collapse-content">
            <p>
              ...
              for any reason, send us a message and as part of our happiness
              guarantee, we'll send you a free replacement pair with your next
              shipment. Only active subscribers can request replacement socks,
              and you can only do so once every 6 months. If your subscription
              is canceled or expired, you won't be able to exchange your socks.
            </p>
          </div>
        </div>
      </div>

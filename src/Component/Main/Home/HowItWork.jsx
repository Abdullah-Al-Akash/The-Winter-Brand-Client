        ...
        <div className='container mx-auto py-16 md:px-0 px-8'>
            ...
            <div className="howWork grid md:grid-cols-3 gap-12 py-8">
                <div className='shadow-2xl py-8 rounded-lg'>
                    ...
                    <div className='mt-4'>
                        <h3 className='text-center brand-color font-semibold'>Choose Age</h3>
                        <div className='md:px-10 mt-2'>
                            <p className='text-center'>Each season, we curate a box of the hottest deals. You make it 100% you.</p>
                        </div>
                    </div>
                </div>
                <div className='shadow-2xl py-8 rounded-lg'>

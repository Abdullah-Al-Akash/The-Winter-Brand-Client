...
const ContactComponents = () => {
  return (
    <div className="md:max-w-[700px] mx-auto my-[100px]">
      <div className="flex flex-col justify-center  w-full md:w-[80%] mx-auto items-center gap-10">
        <h1 className="text-6xl font-bold">Hello, how are you? </h1>

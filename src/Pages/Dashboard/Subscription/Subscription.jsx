            ...
            <div className="my-8 bg-slate-50 shadow rounded p-5">
                ...
                <div className="relative">
                    <ul className="flex gap-5 items-stretch my-5 py-2">
                        ...
                        <li onClick={() => setTap("all-order")} className={tap === "all-order" ? "border-b-2 border-[#0621bb] text-[#0621bb] py-2 uppercase cursor-pointer" : "py-2 uppercase cursor-pointer"}>All Order</li>
                        <li onClick={() => setTap("completed")} className={tap === "completed" ? "border-b-2 border-[#0621bb] text-[#0621bb] py-2 uppercase cursor-pointer" : "py-2 uppercase cursor-pointer"}>Completed</li>
                        ...
                        <li onClick={() => setTap("returned")} className={tap === "returned" ? "border-b-2 border-[#0621bb] text-[#0621bb] py-2 uppercase cursor-pointer" : "py-2 uppercase cursor-pointer"}>Return</li>
                        <li onClick={() => setTap("canceled")} className={tap === "canceled" ? "border-b-2 border-[#0621bb] text-[#0621bb] py-2 uppercase cursor-pointer" : "py-2 uppercase cursor-pointer"}>Cancel</li>
                    </ul>

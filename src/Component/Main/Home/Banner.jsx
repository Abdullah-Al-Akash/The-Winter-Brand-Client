    ...
    return (
        <div className="banner-content">
            ...
            >
                    ...
                    <div className="grid lg:grid-cols-2 gap-4 px-4 md:px-24 py-0 md:py-8">
                        <div className="flex md:items-center">
                            <div
                                ...
                                <h1 className='md:text-4xl text-xl font-semibold mt-2'>with Our</h1>
                                <h1 className='md:text-4xl text-xl mt-3'>Cozy <span className="brand-color font-semibold">Beanie Bundle</span>!</h1>
                                <h3 className='text-gray-300 text-sm mt-5'>Everything in one Bundle: Unparalleled Quality, Unbeatable Price, and Fashion Forward</h3>
                                <div className='mt-3'>
                ...
                <SwiperSlide className=''>
                    <div
                        className="grid lg:grid-cols-2 gap-4 px-4 md:px-24 py-0 md:py-8">
                        <div data-aos="fade-left"
                            ...
                            data-aos-easing="ease-in-out"
                            data-aos-mirror="true"
                            data-aos-once="false" className='flex justify-center md:items-center md:h-[450px] md:w-[450px] mx-auto h-[250px] w-[250px]'>
                            <div className=''>
                                <img src={img} alt="" />
                            </div>
                        </div>

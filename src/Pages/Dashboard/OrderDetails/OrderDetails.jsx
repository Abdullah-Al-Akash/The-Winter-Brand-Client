...
const OrderDetails = () => {
  ...
  useEffect(() => {
    axiosSecure.get(`/get-order/${id}`).then((res) => {
              ...
              <table className="table table-xs">
                ...
                <tbody>
                  ...
                  <tr className="!border-none text-lg">
                    ...
                    <td>${subtotal ? subtotal : order?.packages?.price}</td>
                  </tr>
                  <tr className="!border-none text-lg">
                    <th></th>
                    <td></td>
                ...
                <div className="w-[800px]">
                  ...
                  <p className="md:grid md:grid-cols-3 gap-4 my-3">
                    ...
                    <span className="col-span-2">
                      {order?.packages?.gift?.gift_message}
                    </span>
                  </p>
                  <p className="md:grid md:grid-cols-3 gap-4 my-3">
                    <span>Gift Recipient Email</span>
                    <span className="col-span-2">
                      {order?.packages?.gift?.gift_recipient_email}
                    </span>
                  </p>
                  <p className="md:grid md:grid-cols-3 gap-4 my-3">
                    <span>Gift Message Date</span>
                    <span className="col-span-2">
                      {moment(order?.packages?.gift?.gift_message_date).format(
                        "D MMM YYYY"
                      )}
                    </span>
                  </p>
                  <p className="md:grid md:grid-cols-3 gap-4 my-3">
                    ...
                    <span className="col-span-2">
                      {moment(order?.packages?.gift?.shipping_date).format(
                        "D MMM YYYY"
                      )}
                    </span>
                  </p>
